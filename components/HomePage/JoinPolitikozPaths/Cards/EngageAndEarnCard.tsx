...
const EngageAndEarnCard: React.FC = () => {
  const t = useTranslations("JoinPolitikozPaths.engageAndEarn");
  ...
  return (
    <div className="p-4 bg-dark text-white rounded-lg shadow-lg flex flex-col h-full">
      ...
      {/* Botão desabilitado com Coming Soon */}
      <div className="mt-6 text-center">
      <span className="text-xs text-red-400 mt-1 block">Coming Soon</span>
        <button
          disabled
          className="w-full bg-gray-700 text-white text-sm py-2 font-pixel rounded-lg cursor-not-allowed opacity-60"
        >
          {cardData.button}
        </button>        
      </div>
...
export default EngageAndEarnCard;
