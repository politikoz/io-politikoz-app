...
interface Props {
  onShowHistory: () => Promise<void>; // Update type to Promise<void>
}

const SwapHistoryPlaceholder = memo(function SwapHistoryPlaceholder({ onShowHistory }: Props) {
      ...
      <div className="relative">
        ...
        <div className="space-y-2 opacity-50 blur-[1px]">
          <div className="animate-pulse space-y-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="grid grid-cols-5 gap-4 px-4 py-3 bg-gray-800/20 rounded">
...
export default SwapHistoryPlaceholder;